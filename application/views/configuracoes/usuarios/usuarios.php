<div class="easyui-layout" style="width:100%;height:100%;">
    <div data-options="region:'west',split:true" title="Permissões" style="width:50%;">
        <table id="dgUsuarios"
            ...
            <thead>
                <tr>
                    ...
                    <th field="usuario" width="30">NOME</th>
        ...
        <div id="toolbarUsuario">
            ...
            <div id='menuBuscaUsuarios' style='width:auto'>
                ...
                <div name='usuario'>NOME</div>
                <div name='email'>E-MAIL</div>
            </div>
        </div>
    </div>
    <div id="conteudoProjetos" region="center" title="Projetos">
        <?php if(isset($view)){ $this->load->view($view);} ?>
    </div>
</div>

<div id="dlgUsuarios" class="easyui-dialog" style="width:640px;height:300px" 
...
//ABRE INFORMAÇÕES DOS PROJETOS COM 1 CLICK
$('#dgUsuarios').datagrid({
    onClickRow: function(index,row){
        var row = $('#dgUsuarios').datagrid('getSelected');
        $('#conteudoProjetos').panel('refresh', '<?php base_url();?>projetos/conteudo_projetos/'+row.id_usuario);
    }
});
